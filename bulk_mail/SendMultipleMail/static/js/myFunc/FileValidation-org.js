...
function checkFileValidation(fileName226, form) {    
    console.log("line8>>fileName225>>>"+fileName226);

    const fileName1 = fileName226 //fileUploadField0.files[0].name;
    console.log("filevalidation>>line17>>>fileName1>>>"+fileName1);
    ...
    if (file_ext === "doc" || file_ext === "docx") {
        ...
        console.log("else statement was hit. line#24 FileValidation.js");
      
        // open modal to show error msg
        $("#file_upload_validation_modal1771").click();
